...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/ssh/nginx.conf"
...
sed -i 's/DROPBEAR_EXTRA_ARGS=/DROPBEAR_EXTRA_ARGS="-p 50000 -p 109 -p 110 -p 69 -p 1194"/g' /etc/default/dropbear
...
wget -O clearcache "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/menu/clearcache.sh"
wget -O m-ssws "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/menu/m-ssws.sh"
wget -O m-trojan "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/menu/m-trojan.sh"
