...
cd 
wget -O /usr/local/bin/ohp "https://raw.githubusercontent.com/rasta-team/multi/main/FILE/OPENVPN/ohp"
...
echo -e "Link Download OVPN OHP: http://$MYIP:89/client-tcp-ohp1194.ovpn"
